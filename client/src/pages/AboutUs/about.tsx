    ...
    <div>
      <section className=" pt-[150px] mx-48 mb-[4rem]">
        <div className="">
          ...
          <p className="text-[42px] font-semibold text-center leading-[60px] tracking-[-0.02em] mt-[10px] text-base-greyDark">
            Innovating healthcare with AI-driven chronic <br /> disease
            management solutions.
          </p>
        </div>
        <div className="mt-[10px]">
          <p className="text-[15px] font-normal my-8 text-center leading-[30px] font-inter text-base-greyPrimary">
          ...
          <p className="text-[15px] font-normal text-center my-8 leading-[30px] font-inter text-base-greyPrimary">
