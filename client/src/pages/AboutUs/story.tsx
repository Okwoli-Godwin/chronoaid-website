  ...
  return (
    <div>
      <section className="px-16 my-[4rem]">
        <div>
          <p className="text-[16px] font-semibold text-left leading-[24px] text-base-bluePrimary">
            Our story
          </p>
        </div>
        <div className="flex flex-row justify-between ">
          <div className="flex-1 pr-4">
            <div className="text-[30px] font-semibold leading-[44px] tracking-[-0.02em] text-base-greyDark pb-3">
              <p>
